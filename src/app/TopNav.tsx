        ...
        >
            ...
            <div className='flex flex-row gap-5'>
                <img src='/images/thought_icon.png' className='h-6' alt='deepThoughts'
                     onClick={ () => showDeepThoughtsModal() }/>
                <img src={ appState.debug ? '/images/bug-blue.png' : '/images/bug-white.png' } className="h-6"
                     alt="debugToggle" onClick={ () => toggleDebug() }/>
                <img src={ appState.sound ? '/images/sound-on.png' : '/images/sound-off.png' } className="h-6"
                     alt="soundToggle" onClick={ () => toggleSound() }/>
            </div>
        </Navbar>
